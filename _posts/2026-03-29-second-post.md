...
Before we dive into each type, here is a simple way to visualize all three together:
...
<hr style="width: 370px; border: none; height: 3px; background-color: #7faf8f; margin: 8px 0 16px 0; border-radius: 2px;">
 
<p>This is when something is physically blocking sound from getting through.</p>

<h3>What It Is</h3>

<p>This occurs when sound cannot travel efficiently through the outer or middle ear.</p>
...
<p>Often treatable or reversible, depending on the cause.</p>
...
<hr style="width: 400px; border: none; height: 3px; background-color: #8cc8f0; margin: 8px 0 16px 0; border-radius: 2px;">
...
<p>This happens when there is damage to the inner ear or auditory nerve. It is typically permanent.</p>
...
<p>Usually permanent, but very manageable with the right support and technology.</p>

</div>



<div style="background: #f3effc; padding: 22px; border: 1px solid #c8b6f0; border-radius: 14px; margin: 32px 0;">

<h2>Mixed Hearing Loss</h2>

<hr style="width: 290px; border: none; height: 3px; background-color: #c8b6f0; margin: 8px 0 16px 0; border-radius: 2px;">

<p>This is where both types come together, which can make things feel more difficult.</p>

<h3>What It Is</h3>

<p>A combination of conductive and sensorineural hearing loss.</p>
...
<p>Requires treating both parts of the problem for the best outcome.</p>
...
Many people experience some form of hearing loss at different points in life.  

The good news is, there are many ways to understand, process and manage it.

The most important thing right now isn’t to figure everything out on your own, but to recognize that help is available.
